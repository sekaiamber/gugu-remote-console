...
import { getComputedStyle, removeDefComputedStyle, getMatchedCSSRules } from './utils';
// modules
...
const storeConfig = {
  writers: {
    element: { clean: true, beforeSend: (data, encodeData) => {
      const ret = data ? LZString.compressToUTF16(encodeData) : data;
      console.info(encodeData.length, ret.length);
      return ret;
    } },
  },
};
